...
class Square():
    def __init__(self, position, is_terrain, char, env_effects):
        self.position = position
        self.is_terrain = is_terrain
        self.character_in_pos = char
...
class Character():
    def __init__(self, char_id, controlling_player, stre, dex, con, intt, wis, cha, ac, hp, speed):
...
x = Square(position=10, is_terrain=False, char=char, env_effects=False)
y = Square(position=11, is_terrain=False, char=char, env_effects=False)

print(x.char.speed_left)
y.char.reduce_speed(2)
print(x.char.speed_left)
y.char.reduce_speed(2)
print(x.char.speed_left)